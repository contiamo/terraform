...
* **ecr-pull-helper**: drop kubernetes provider version pin
* **ci**: sort releases by semver, not publication date
...
* **envoy-gateway**: add CRDs v1.7.2
* **envoy-gateway**: add CRDs v1.6.5

## [0.15.0] (2026-04-15)

### Features

* **monitoring**: bump kube-prometheus-stack to 83.4.3 and migrate to Gateway API

### Bug Fixes

* **monitoring**: use map for additionalPrometheusRulesMap to match kps 83.x

## [0.14.0] (2026-04-14)

### Features

* **envoy-gateway**: manage Envoy Gateway CRDs from rendered YAML
